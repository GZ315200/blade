...
import com.igeek.ws_client.pojo.OkHttpResponse;
import com.igeek.ws_client.exception.GeneralServiceException;
        ...
        okHttpClient.newCall(request)
                .enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        String msg = MessageFormat.format("异步post请求错误,url:{0},com.igeek.ws_client.exception-message:{1}", call.request().url(), e.getMessage());
                        LOGGER.error(msg, e);
                    }
